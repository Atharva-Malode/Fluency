...
const Login = () => {
  ...
  //       // Extracting the access_token from the response data
  //       const token = responseData.data.access_token;

  //       // Print the token in the console for debugging
        
  //       cokkie.set('bearerToken', token);
  //       // console.log("Bearer Token:", token); 
  //       // const short = cokkie.get('bearerToken');
  //       // console.log(short);

  //       setLoginStatus("success");

  //       // Redirect to the home page after successful login (for debugging purposes)
  //       setTimeout(() => {
  //         navigate("/");
